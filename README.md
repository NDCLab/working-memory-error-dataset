...
- **`code/statistics/`**: Contains all scripts used for the statistical analyses reported in the paper.
...
- **`code/face-morphing/`**: Contains a face morphing script used to create the stimuli.
- **`derivatives/csv/`**: Contains all datasets used for the statistical analyses reported in the paper.
